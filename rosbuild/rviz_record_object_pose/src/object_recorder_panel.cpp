...
//#include <pr2_pbd_interaction/GuiCommand.h>
...
#include "object_recorder_panel.h"
...
ObjectRecorderPanel::ObjectRecorderPanel()
    : node_handle_("") {
  record_object_publisher_ = node_handle_.advertise<pr2_pbd_speech_recognition::Command>(
      kDefaultTopic, 5);
//  record_object_publisher_ = node_handle_.advertise<pr2_pbd_interaction::GuiCommand>(
//      kDefaultTopic, 5);
...
*/
// add button
  publish_button_ = new QPushButton(QString::fromStdString("Record object pose"));
 ...
 */
/*
void ObjectRecorderPanel::UpdateOutputTopic() {
 ...
 */
void ObjectRecorderPanel::UpdatePublishButton() {
  pr2_pbd_speech_recognition::Command cmd;
//  pr2_pbd_interaction::GuiCommand cmd;
  cmd.command = "record-object-pose";
 ...
 */
/*
void ObjectRecorderPanel::Update() {
  if (IsPublishing()) {
 ...
 */
/*
bool ObjectRecorderPanel::IsPublishing() {
 ...
 */
/*
void ObjectRecorderPanel::GetCameraPose(geometry_msgs::Pose* pose) {
...
PLUGINLIB_EXPORT_CLASS(rviz_record_object_pose::ObjectRecorderPanel, rviz::Panel)
